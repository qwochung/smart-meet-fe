...
import {
  ArrowRight, Calendar, Clock, Link as LinkIcon, Mic, MicOff,
  MonitorSpeaker, Video, VideoOff, Wand2, MonitorUp, Cast
} from 'lucide-react';
...
export default function JoinMeetingPage() {
  ...
  // Sau khi isCamOn = true, video element vừa mount → gán lại srcObject
  useEffect(() => {
    ...
    <div className="flex min-h-screen flex-col bg-slate-50 text-slate-900">
      <main className="flex flex-1 items-center justify-center p-6 lg:p-12">
        <div className="flex w-full max-w-[1100px] flex-col gap-10 lg:flex-row lg:items-center lg:gap-14">
          ...
          <div className="flex-1 space-y-6">
            <div>
              <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl text-center lg:text-left">Ready to join?</h1>
              <p className="mt-2 text-slate-500 text-center lg:text-left">Check your audio and video before entering the call.</p>
            </div>
            ...
            <div className="overflow-hidden rounded-3xl bg-slate-900 shadow-xl shadow-slate-300 relative border-4 border-white">
              <div className="aspect-video w-full bg-[#0f172a]">
                {isCamOn ? (
                  ...
                  <div className="grid h-full place-items-center bg-slate-100 border border-slate-200">
            ...
            <div className="flex justify-center gap-6">
              <div className="flex flex-col items-center gap-2 text-xs font-bold tracking-wider text-slate-500">
                <button
                  onClick={toggleMic}
                  className={`flex h-[52px] w-[52px] items-center justify-center rounded-full transition-all shadow-md ${isMicOn
              ...
              <div className="flex flex-col items-center gap-2 text-xs font-bold tracking-wider text-slate-500">
                <button
                  ...
                  className={`flex h-[52px] w-[52px] items-center justify-center rounded-full transition-all shadow-md ${isCamOn
                      ? 'bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-blue-600 hover:border-blue-200'
                      : 'bg-red-50 text-red-600 border border-red-200 hover:bg-red-100'
                    }`}
                >
          ...
          <div className="w-full lg:w-[420px] rounded-[24px] bg-white border border-slate-200 shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-8">
            ...
            <div className="mt-5 flex items-center gap-5 text-sm font-medium text-slate-600 bg-slate-50 p-3 rounded-xl border border-slate-100">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-blue-600 hover:underline cursor-pointer">nexus.meet/prod-sync</span>
              </div>
            </div>
            ...
            <div className="mt-8">
              <div className="flex items-center justify-between text-xs font-bold uppercase tracking-widest text-slate-500">
                ...
                <button className="text-blue-600 hover:text-blue-700 hover:underline">Change</button>
              </div>
              <div className="mt-3 space-y-2 rounded-2xl bg-white p-4 text-sm font-medium text-slate-700 border border-slate-200 shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <span className="truncate">MacBook Pro Microphone (Built-in)</span>
                </div>
      ...
      <footer className="flex flex-col items-center justify-center pb-8 pt-4">
        ...
        <p className="mt-8 text-xs font-medium text-slate-400">
          © 2024 Nexus Meet. Secure, encrypted, and professional video conferencing.
        </p>
      </footer>
    </div>
  );
